              ...
              <motion.div variants={cardVariants}>
                <Card className="holo-card border-0 shadow-lg"
                  ...
                  <Card.Header className="border-0 text-center py-4"
                               style={{ 
                                 background: 'linear-gradient(135deg, rgba(124, 201, 255, 0.1), rgba(110, 58, 255, 0.1))',
                    ...
                    >
                      <div 
                        ...
                        style={{
                          ...
                          boxShadow: '0 10px 30px rgba(124, 201, 255, 0.3)'
                        }}
                      >
                    ...
                    <h2 className="fw-bold mb-2 holo-glow">Welcome Back</h2>
                    <p className="mb-0" style={{ color: '#B8C5D6' }}>Sign in to your PhishShield account</p>
                  </Card.Header>
                    ...
                    <Form onSubmit={handleLogin}>
                      ...
                      >
                        <Button
                          ...
                          style={{
                            background: loading 
                              ? 'rgba(124, 201, 255, 0.3)' 
                              : 'linear-gradient(135deg, #7CC9FF, #6E3AFF)',
                            border: 'none',
                            borderRadius: '12px',
                            fontSize: '1.1rem',
                            boxShadow: '0 8px 25px rgba(124, 201, 255, 0.3)',
